...
while p1 is False or p2 is False or p3 is False:
    ...
    if player1 < 22:
        if not p1:
            ...
            print("Игрок1 вышел из игры со счётом", player1,'\n')
    if goodgame==1:
        break
    if player2 < 22:
        if not p2:
            ...
            print("Игрок2 вышел из игры со счёт", player2,'\n')
    if goodgame==1:
        break
    if int(player3) < 22:
        if not p3:
            ...
            print("Игрок3 вышел из игры со счётом", player3,'\n')
    if goodgame==1:
        break
